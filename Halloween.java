...
public class Halloween {
            ...
            while (actualHouse <= APARTMENTS_PER_FLOOR) {
                ...
                if (calculateOpen >= OPEN_HOUSE_CHANCE) {
                    ...
                    if (fullBagOne = true) {
                        ...
                        GiveCandies(MAX_CANDY_PER_HOUSE, MIN_CANDY_PER_HOUSE, candy);
    ...
    static int GiveCandies(int MAX_CANDY_PER_HOUSE, int MIN_CANDY_PER_HOUSE, int candy){
            int calcCandy = (int) (Math.random() * (MAX_CANDY_PER_HOUSE - MIN_CANDY_PER_HOUSE + 1) + MIN_CANDY_PER_HOUSE);
            System.out.println(calcCandy);
            candy = calcCandy;
            return(candy);
        }
}
